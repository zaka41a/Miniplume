...
<section class="home-hero">
  <div class="home-hero-bg">
    ...
    <!-- Floating Orbs avec parallaxe -->
    <div class="home-hero-orbs" data-speed="0.3">
    ...
    <!-- Light effect qui suit la souris -->
    <div class="mouse-light"></div>
  </div>

  <div class="home-hero-content" data-speed="0.5">
    ...
    <p class="home-hero-subtitle">
      Entdecken Sie prägnante und technische Artikel über PHP, moderne Webentwicklung
      und Best Practices. Werden Sie Teil unserer Experten-Community.
    </p>
    ...
    <div class="home-hero-actions">
      <a href="#articles" class="home-btn home-btn-primary">
        ...
        <span class="home-btn-particles"></span>
      </a>
...
<!-- Articles Section -->
<?php if (empty($posts)): ?>
  <div class="home-empty reveal-on-scroll">
  ...
  <div id="articles" class="home-section">
    ...
    <div class="home-posts">
      <?php foreach ($posts as $index => $p): ?>
        <article class="home-card reveal-on-scroll" style="--card-index: <?= $index ?>">
          <div class="home-card-glow"></div>
          <div class="home-card-shine"></div>
...
<?php if (class_exists('Auth') && \Auth::check()): ?>
  <div style="text-align: center; margin-top: 3rem;" class="reveal-on-scroll">
    <a href="/me/comments" class="home-btn home-btn-secondary">
      <span class="home-btn-content">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
        </svg>
        <span class="home-btn-text">Meine Kommentare</span>
      </span>
      <span class="home-btn-border"></span>
    </a>
  </div>
...
.home-stat:hover .home-stat-visual {
...
.home-card:hover .home-card-shine {
...
(function() {
  ...
  document.addEventListener('mousemove', (e) => {
    ...
    isInHero = e.clientY < rect.bottom;
